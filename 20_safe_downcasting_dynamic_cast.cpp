...
//   //Safe Downcast
//   Circle* ps1 = dynamic_cast<Circle*>(ps);
//   if(ps1)
//   {
//     ps1->getDiameter();
//   }
//   else {
//     std::cout<<"Shape pointer cannot be downcasted"<<std::endl;
//   }
//   ps = &circle_obj;
//   Circle* ps2 = dynamic_cast<Circle*>(ps);
//   if(ps2)
//   {
//     std::cout<<ps2->getDiameter()<<std::endl;
//   }
//   else {
//     std::cout<<"Shape pointer cannot be downcasted"<<std::endl;
//   }
